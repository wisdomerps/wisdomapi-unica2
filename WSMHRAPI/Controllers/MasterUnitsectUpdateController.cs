...
{
    public class MasterUnitsectUpdateController : ApiController
    {
        ...
        public IHttpActionResult Post(MasterUnitSectModel MasterUnitSect)
        {
            try
            {
                if (MasterUnitSect.FTUnitSectCode != "")
                {
                    ...
                    {
                        //VerrifyData  
                        if (MasterClass.VerrifyDuplication(_table, _filed, MasterUnitSect.FTUnitSectCode, MasterUnitSect.FNHSysCmpId, MasterUnitSect.FNHSysUnitSectId))
                        {                           
                            //update
                            if (MasterClass.UpdateMaster(_table, MasterUnitSect.FTUnitSectCode, MasterUnitSect.FNHSysCmpId, PK, MasterUnitSect.FTUnitSectNameTH, MasterUnitSect.FTUnitSectNameEN, MasterUnitSect.FTRemark, MasterUnitSect.username,0, MasterUnitSect.FNHSysUnitSectId, MasterUnitSect.FTStateActive, ref msgDesc))
                            {
                                a.Status = true;
                                a.StatusCode = 200;
                                a.Messege = msgDesc;
