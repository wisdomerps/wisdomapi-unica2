...
{
    public class MasterDivisionUpdateController : ApiController
    {
            ...
            try
            {
                if (MasterDivision.FTDivisonCode != "")
                {
                    ...
                    if (MasterDivision.FTDivisonCode.ToString() != "" && MasterDivision.FNHSysDivisonId.ToString() != "")
                    {
                        ...
                        //VerrifyData  
                        if (MasterClass.VerrifyDuplication(_table, PK, MasterDivision.FTDivisonCode, MasterDivision.FNHSysCmpId, MasterDivision.FNHSysDivisonId))
                        {
                            //verify Use

                            //update
                            if (MasterClass.UpdateMaster(_table, MasterDivision.FTDivisonCode, MasterDivision.FNHSysCmpId, PK, MasterDivision.FTDivisonNameTH, MasterDivision.FTDivisonNameEN, MasterDivision.FTRemark, MasterDivision.username, 0, MasterDivision.FNHSysDivisonId, MasterDivision.FTStateActive, ref msgDesc)) { 
                               a.Status = true;
                                a.StatusCode = 200;
                                a.Messege = msgDesc;
